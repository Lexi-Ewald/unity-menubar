...
- Unity-menubar.patch is tested for firefox version (>= 145.0*)
...
**Tip:**
- Developers of the alpha and beta versions of Firefox and Thunderbird should use the development branch (dev branch) and not the main branch.
